    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#13131a] flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white dark:bg-[#1c1c27] border border-gray-100 dark:border-[#2a2a38] rounded-2xl p-8">
          <h1 className="text-lg font-medium text-gray-900 dark:text-[#e8e6f8] mb-1">Sign in</h1>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              <label className="text-xs font-medium text-gray-500 dark:text-[#555] block mb-1.5">Email</label>
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-9 pr-4 py-2.5 text-sm bg-gray-50 dark:bg-[#13131a] border border-gray-200 dark:border-[#2a2a38] rounded-lg text-gray-900 dark:text-[#e8e6f8] placeholder-gray-300 dark:placeholder-[#333] focus:outline-none focus:border-[#534AB7]"
                />
              </div>
            </div>
            <div>
              <label className="text-xs font-medium text-gray-500 dark:text-[#555] block mb-1.5">Password</label>
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  required
                  className="w-full pl-9 pr-10 py-2.5 text-sm bg-gray-50 dark:bg-[#13131a] border border-gray-200 dark:border-[#2a2a38] rounded-lg text-gray-900 dark:text-[#e8e6f8] placeholder-gray-300 dark:placeholder-[#333] focus:outline-none focus:border-[#534AB7]"
                />
                <button
                  type="button"
